...
import com.example.interprotocol_project.bluetooth.BluetoothFileTransfer;
import com.example.interprotocol_project.bluetooth.Opptransfer;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mButton1.setOnClickListener(
				new OnClickListener() {
					public void onClick(View v) {
						imageDownloader.getFile(MainActivity.this);
					}
				});
	}
		...
		switch(0)
		{
			case 0:
				try {
					...
					mBluetoothFileTransfer = new BluetoothFileTransfer(this, null, imgUri, mHandler);
